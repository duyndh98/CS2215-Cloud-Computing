...
def training_individual():
    ...
    subprocess.call(("mlflow", "run -e train --experiment-id 102743343880908033 --env-manager=local hyperparam"))

    return

def training_hyperopt():

    os.chdir('/root/airflow/dags')
    subprocess.call(("mlflow", "run -e hyperopt --experiment-id 301380945204689256 --env-manager=local hyperparam"))
